...
//       {/* Using <a> tag for Export Excel as a link */}
//       <a
//         href="#"
...
//   const handleConfirm = () => {
//     alert("Confirmed with Data: " + JSON.stringify(modalData));
//     setIsModalOpen(false); // Close the modal after confirming
//   };
...
//               />
//               {modalData.image && (
//                 <p>Uploaded Image: {modalData.image}</p>
//               )}
//             </div>
//             <div className={styles.modalActions}>
//               <button className={styles.modalButton} onClick={handleCloseModal}>
...
//       const data = {
//         userId: authData.userId, // Assuming the userId is saved in the AuthData
//         applyId: "dcorehost2892424254182", // Generate or fetch this dynamically as needed
//         chargeMoney: parseFloat(modalData.chargeMoney), // Ensure it's a valid number
//         transactionId: modalData.transactionId,
//         state: "Pending", // This is static for now, could be dynamic
//         payway: modalData.payway,
//       };
