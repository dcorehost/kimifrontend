      ...
      <div className={`${styles.sidebar} ${isSidebarOpen ? styles.open : ""}`}>
        ...
        <ul className={`${styles.sidebarLinks} ${isSidebarOpen ? styles.showText : ""}`}>
          ...
          <li>
            ...
            {openMenus.adApproval && (
              <ul className={styles.subMenu}>
                <li><Link to="/admin/adapproval/gapprove" className={styles.link}>Google Ads Approval</Link></li>
                <li><Link to="/admin/adapproval/bapprove" className={styles.link}>Bing Ads Approval</Link></li>
                <li><Link to="/admin/adapproval/fapprove" className={styles.link}>Facebook Ads Approval</Link></li>
              </ul>
            )}
          </li>
