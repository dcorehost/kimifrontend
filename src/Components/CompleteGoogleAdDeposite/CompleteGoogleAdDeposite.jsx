...
import styles from "./CompleteGoogleAdDeposite.module.css"; // Updated filename for Google
import Httpservices from "../Services/Httpservices";
import Auth from "../Services/Auth";

const CompleteGoogleAdDeposite = () => {
  ...
  const fetchDepositsData = async () => {
    ...
    try {
      const response = await Httpservices.get("https://admediaagency.online/kimi/get-complete-google-adDeposit", {
...
export default CompleteGoogleAdDeposite;
