  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response?.data) {
        ...
        setTotalCost(totalCalculatedCost);
      }
    } catch (error) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.summary}>
        ...
        <div className={styles.summaryItem}><strong>Total Cost (Including Fees):</strong> <span>${totalCost.toFixed(2)}</span></div>
