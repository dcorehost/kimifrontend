...
//         <div className={styles.infoItem}>
//           <label>Contact</label>
//           <input type="number" name="contact1" value={userData.contact1} disabled />
//         </div>
  ...
  return (
    <div className={styles.container}>
      <div className={styles.profileInfo}>
        ...
        <section className={styles.emailInfo}>
          <p>
            You can change email addresses in your <a href="/dashboard/settings" className={styles.settingsLink}>settings</a>.
          </p>
        </section>
        <div className={styles.infoItem}>
          <label>Mobile</label>
          <input type="number" name="mobile" value={userData.mobile} onChange={handleInputChange} placeholder="Enter your mobile number" />
        </div>
      ...
      <div className={styles.passwordUpdate}>
        ...
        {passwordError && <p className={styles.error}>{passwordError}</p>}
        <button className={styles.saveButton} onClick={handlePasswordUpdate}>Update Password</button>
      </div>
    </div>
  );
};
